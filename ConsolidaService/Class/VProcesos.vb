Public Class VProcesos
    ...
    Public Property pathXSLT() As String
        Get
            Return m_pathXSLT
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Shared m_pathXSLT As String
    ...
    'Public Shared XMLFiles As List(Of ArchivoXML) = New List(Of ArchivoXML)
    'Public Shared Nominas As List(Of Nomina) = New List(Of Nomina)
    'Public Shared Cheques As List(Of ChequesTranferencias) = New List(Of ChequesTranferencias)
