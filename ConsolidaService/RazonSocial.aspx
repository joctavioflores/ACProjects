<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RazonSocial.aspx.vb" Inherits="ConsolidaService.RazonSocial" %>
...
<body>
    ...
    <table border="0" width="100%" class="tabla-principal">  
        <tr>
            ...
            ImageUrl="~/images/gov.gif" />CATÁLOGO DE RAZONES SOCIALES</td>
        </tr>        
    </table>    
    </div>
    <div>
    <asp:GridView ID="lstrazon" runat="server" 
    GridLines="None"
    AllowPaging="true"
    CssClass="mGrid"
